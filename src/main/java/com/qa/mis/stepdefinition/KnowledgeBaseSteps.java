...
public class KnowledgeBaseSteps {
    ...
    public void logged_in_successfully() throws InterruptedException {
        ...
        try {
            ...
            GemTestReporter.addTestStep("User enters the  username and password", "Username/Password not entered successfully" + e, STATUS.FAIL);
    ...
    public void navigating_to_view_documents_page() throws InterruptedException {
        try{
            ...
            GemTestReporter.addTestStep("user clicks on View Documents", "View Document is not clicked successfully" + e, STATUS.FAIL);
        }}
    ...
    public void add_new_document_tags_icon_is_present_and_functional() {
        try {
            ...
            DriverAction.typeText(KnowledgeBaseLocator.inputDocumentTag, "Test110");
        ...
        {
            GemTestReporter.addTestStep("User enters the new document tag", "document tag not added successfully " + e, STATUS.FAIL);
    ...
    public void navigating_to_view_documents_page_adding_empty_document_tag() throws InterruptedException {
        try {
            ...
            GemTestReporter.addTestStep("Adding empty document tag", "Empty document tag not addedd successfully" + e, STATUS.FAIL);
        }
    ...
    public void throws_warning_message() {
        try {
            ...
            GemTestReporter.addTestStep("User sees the warning message", "Warning message not displayed successfully" + e, STATUS.FAIL);
    ...
    public void navigating_to_my_attendance() {
        try {
            ...
            GemTestReporter.addTestStep("User clicks on attendance", "Clicking on attendance not successful" + e, STATUS.FAIL);
        }
    }
    ...
    public void selecting_and_verifying_the_attendance(String month) throws InterruptedException {
        try{
            ...
            GemTestReporter.addTestStep("User verifies the attendance", "attendance not verified successfully" + e, STATUS.FAIL);
    ...
    public void right_click_functionality_is_working() throws InterruptedException {
        try{
            ...
            GemTestReporter.addTestStep("User right clicks on a folder", "User right clicking on folder not successful " + e, STATUS.FAIL);
        }}
    ...
    public void navigating_to_view_documents_page_and_adding_an_invalid_document_type() throws InterruptedException {
        try{
            ...
            GemTestReporter.addTestStep("User uploads an invalid document", "Invalid document upload not successful" + e, STATUS.FAIL);
        }}
    ...
    public void invalid_document_type_warning_should_be_displayed() {
        try{
            ...
            GemTestReporter.addTestStep("User gets a warning message after uploading invalid file", "Not getting a warning message" + e, STATUS.FAIL);
        }}
    ...
    public void navigating_to_view_documents_page_and_page_is_refreshed() {
        ...
        try{
            ...
            GemTestReporter.addTestStep("User refreshes the view document page", "View document page refresh not successful" + e, STATUS.FAIL);
        }}
    ...
    public void page_is_refreshed() {
        try{
            ...
            GemTestReporter.addTestStep("User refreshed the page", "view document page not refreshed successfully" + e, STATUS.FAIL);
        }}
    ...
    public void navigating_to_view_documents_page_and_searched() throws InterruptedException {
        try{
            ...
            GemTestReporter.addTestStep("User navigates to view document", "user not able to navigate to view document" + e, STATUS.FAIL);
    ...
    public void search_is_functional() {
        try{
            ...
            GemTestReporter.addTestStep("User searches for a document", "User not able to search a document successfully" + e, STATUS.FAIL);
    ...
    public void search_is_functional_and_nothing_is_shown() {
        try{
            ...
            GemTestReporter.addTestStep("User searches for an invalid document", "Search mismatch unsuccessful" + e, STATUS.FAIL);
        }}
    ...
    public void navigating_to_view_documents_page_and_renaming_the(String folderRename) throws InterruptedException {
        try{
            ...
            GemTestReporter.addTestStep("User renames the folder", "user not able to rename the folder" + e, STATUS.FAIL);
        }}
    ...
    public void navigating_to_view_documents_page_and_selecting_from_dropdown(String string) throws InterruptedException {
        try{
            ...
            GemTestReporter.addTestStep("User selects a document from dropdown", "user not able select from the dropdown and is not functional " + e, STATUS.FAIL);
        }}
    ...
    public void navigating_to_view_document_and_is_selected(String string) throws InterruptedException {
        try{
            ...
            GemTestReporter.addTestStep("User right clicks to delete  the folder", "user not able to delete the folder" + e, STATUS.FAIL);
        }}
    ...
    public void navigating_to_view_document_and_is_selected_and_is_selected(String string, String string2) throws InterruptedException {
        try{
            ...
            GemTestReporter.addTestStep("User deletes the subfolder in view document", "user not able to delete the subfolder in view document" + e, STATUS.FAIL);
    ...
    public void navigating_to_view_document_and_title_sort_applied() throws InterruptedException {
        try{
            ...
            GemTestReporter.addTestStep("User applies the title sort", "title sort applied in view document not successful" + e, STATUS.FAIL);
        }}
    ...
    public void navigating_to_view_document_and_date_sort_applied() throws InterruptedException {
        try{
            ...
            GemTestReporter.addTestStep("User applies the date sort", "date sort applied in view document not successful" + e, STATUS.FAIL);
    ...
    public void navigating_to_view_document_and_adding_folder() throws InterruptedException {
        try{
            ...
            GemTestReporter.addTestStep("User add the folder in view document", "adding the folder in view document not successful" + e, STATUS.FAIL);
    ...
    public void navigating_to_view_document_and_adding_subfolder_to(String string) throws InterruptedException {
        try{
            ...
            GemTestReporter.addTestStep("User add the sub folder in view document", "adding the sub folder in view document not successful" + e, STATUS.FAIL);
    ...
    public void navigating_to_view_document_and_adding_folder_with_duplicate_name() throws InterruptedException {
        try{
            ...
            GemTestReporter.addTestStep("User add the folder with duplicate name in view document", "adding the folder with duplicate name in view document not successful" + e, STATUS.FAIL);
    ...
    public void navigating_to_view_document_and_adding_subfolder_with_duplicate_name_to(String string) throws InterruptedException {
        try{
            ...
            GemTestReporter.addTestStep("User add the subfolder folder with duplicate name in view document", "adding the subfolder with duplicate name in view document not successful" + e, STATUS.FAIL);
    ...
    public void navigating_to_view_documents_page_and_adding_an_valid_document_type() throws InterruptedException {
        try{
            ...
            GemTestReporter.addTestStep("User adds a valid document in view document", "adding the valid document in view document not successful" + e, STATUS.FAIL);
    ...
    public void navigating_to_view_shared_documents_page_and_selecting_from_dropdown(String string) throws InterruptedException {
        try{
            ...
            GemTestReporter.addTestStep("User selects from a dropdown in view shared document", "Selecting dropdown in view shared document not successful" + e, STATUS.FAIL);
    ...
    public void navigating_to_view_shared_documents_page_and_searching_a(String string) throws InterruptedException {
        try{
            ...
            GemTestReporter.addTestStep("User searches for a document in view shared document", "Searching document in view shared document not successful" + e, STATUS.FAIL);
    ...
    public void navigating_to_view_shared_documents_page_and_searching_an_absent(String string) throws InterruptedException {
        try{
            ...
            GemTestReporter.addTestStep("User makes an empty search in view shared document", "Empty search in view shared document not successful" + e, STATUS.FAIL);
    ...
    public void navigating_to_view_shared_documents_page_and_applying_ascending_title_sort() throws InterruptedException {
        try{
            ...
            GemTestReporter.addTestStep("User applies title sort in view shared document", "Tile sort in view shared document not successful" + e, STATUS.FAIL);
    ...
    public void navigating_to_view_shared_documents_page_and_clicking_on_next_button() throws InterruptedException {
        try{
            ...
            GemTestReporter.addTestStep("User clicks on next button in view shared document", "Clicking on next button in view shared document not successful" + e, STATUS.FAIL);
    ...
    public void navigating_to_view_shared_documents_page_and_clicking_on_previous_button() throws InterruptedException {
        try{
            ...
            GemTestReporter.addTestStep("User clicks on previous button in view shared document", "Clicking on previous button in view shared document not successful" + e, STATUS.FAIL);
    ...
    public void navigating_to_view_shared_documents_page_and_viewing_the(String string) throws InterruptedException {
        try{
            ...
            GemTestReporter.addTestStep("User opens a document in view shared document", "Opening a document in view shared document not successful" + e, STATUS.FAIL);
    ...
    public void document_is_opened() throws InterruptedException {
        try{
            ...
            GemTestReporter.addTestStep("Document opens in view shared document", "Document opened in view shared document not successful" + e, STATUS.FAIL);
    ...
    public void navigating_to_view_shared_documents_page_and_applying_ascending_shared_by_sort() throws InterruptedException {
        try{
            ...
            GemTestReporter.addTestStep("User applies shared sort in view shared document", "Shared sort in view shared document not successful" + e, STATUS.FAIL);
    ...
    public void navigating_to_view_shared_documents_page_and_applying_ascending_tag_sort() throws InterruptedException {
        try{
            ...
            GemTestReporter.addTestStep("User applies tag sort in view shared document", "Tag sort in view shared document not successful" + e, STATUS.FAIL);
    ...
    public void navigating_to_view_shared_documents_page_and_applying_ascending_date_sort() throws InterruptedException {
        try{
            ...
            GemTestReporter.addTestStep("User applies date sort in view shared document", "Date sort in view shared document not successful" + e, STATUS.FAIL);
