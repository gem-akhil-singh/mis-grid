...
Feature: LNSA Feature - MIS Automation GemJar
  ...
  Scenario: LNSA - User clicks on the Previous and Next Buttons from Apply LNSA page
  ...
  Scenario: LNSA - User selects any week using the checkboxes on Apply LNSA page
    And User selects "Apply LNSA" from menu panel
  ...
  Scenario: LNSA - User selects a day and Submits the LNSA
    And User selects "Apply LNSA" from menu panel
  ...
  Scenario: LNSA - User selects a day and clicks on the cancel button
    And User selects "Apply LNSA" from menu panel
    Then User selects a day for which LNSA has not been applied
    And User enters the reason for LNSA submission
    Then User clicks on the "Cancel" of Reason pop-up

  Scenario: LNSA - User navigates to the View Request Status option of LNSA page and checks th Export functionality
  ...
  Scenario Outline: LNSA - User searches for LNSA entries using keyword <search entry> on the View Request Status of LNSA page
    And User selects "View Request Status" from menu panel
  ...
  Scenario: LNSA - User get the total number of entries on LNSA View Request Status page and sorts the column
    And User selects "View Request Status" from menu panel
  ...
  Scenario: LNSA - User tries to view LNSA Request Detail on LNSA Page
    And User selects "View Request Status" from menu panel
