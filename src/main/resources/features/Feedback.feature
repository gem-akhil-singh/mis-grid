...
Feature: Feedback Feature - MIS Automation GemJar
  ...
  Scenario: Feedback - Submitting a feedback
  ...
  Scenario: Feedback - User tries to navigate between the pages of Feedback page
  ...
  Scenario Outline: Feedback - User searches for feedback entries using keyword <search entry> on the Feedback page
  ...
  Scenario: Feedback - User checks for the Export options available on Feedback page
    Then User checks if the Export button is available
    And User clicks on the Export button

  Scenario: Feedback - User tries to view an existing feedback on Feedback Page
    Then User clicks on the View icon
    And User verifies that the "View Feedback" pop-up appears

  Scenario: Feedback - User get the total number of entries on Feedback page and sorts the column
